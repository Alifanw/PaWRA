...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $superRoleId = $superRole ? $superRole->id : 1;
        ...
        if (\Illuminate\Support\Facades\Schema::hasTable('role_user') && $superRole) {
        ...
        if (\Illuminate\Support\Facades\Schema::hasTable('role_user') && $superRole) {
            $aliasUser->roles()->syncWithoutDetaching([$superRole->id]);
        }
        ...
        if (\Illuminate\Support\Facades\Schema::hasTable('role_user') && $adminRole) {
        ...
        if (\Illuminate\Support\Facades\Schema::hasTable('role_user') && $cashierRole) {
